...
object NotificationUtils {
    ...
    private const val NOTIFICATION_CHANNEL_ID = "au.com.unison.meshagent.ttm.app"
    private const val NOTIFICATION_CHANNEL_NAME = "au.com.unison.meshagent.ttm.app"
    ...
    private fun createNotification(context: Context): Notification {
        ...
        builder.setSmallIcon(au.com.unison.meshagent.ttm.R.drawable.ic_camera)
        builder.setContentTitle(context.getString(au.com.unison.meshagent.ttm.R.string.meshcentral))
        builder.setContentText(context.getString(au.com.unison.meshagent.ttm.R.string.displaysharing))
